	        ...
	        .const screenbeg = $428     // top of text scr
	        .const screenend = $7e8     // end of text scr
	        .const rows = 24            // screenend-screenbeg/columns
	        .const bufferbeg = $4000	// start of text buffer memory
	        .const bufferend = $7fff	// end of text buffer memory
            .const commandnum = 39
            ...
            // *** variables (zero-page) ***
	        .const vars = $02
	        .const row = $02            // screen row 0-24
	        .const col = $03            // screen col 0-39
	        .const shift = $04          // off screen left
	        .const line = $05           // text line counter
	        .const cnt = $07            // display line counter
	        .const num = $08            // general purpose
	        .const disflg = $09         // negative=no display
	        .const varnum =  8

            // *** pointers ***
	        .const ptr = $3d            // utility pointer
	        .const top = $3f            // top line of text window
	        .const end = $2d            // end of text
	        .const txt = $fd            // current text position
	        .const scr = $fb            // current screen position
